...
- Navigate your previous query history using the up arrow

### Fixed

- Command searching in Workflow and Startup Builders
- Arrow command selection in Workflow and Startup Builders
- Commands available to Startup Builder
...
- Added new menu commands provided by [@sttk3](https://community.adobe.com/t5/illustrator-discussions/executemenucommand-command-list/m-p/15377798/page/2#M445281)
    - Object > Generative Expand... > Make...
    - Object > Generative Expand... > Combine
    - Object > Print Bleed...
