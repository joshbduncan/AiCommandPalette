...
var builtCommands = {
  menu: {
    ...
    menu_quit: {
      action: "quit",
      type: "menu",
      loc: { en: "File > Exit", de: "Datei > Illustrator beenden", ru: "Файл > Выход" },
    },
    menu_undo: {
      action: "undo",
      type: "menu",
    ...
    "menu_Horizontal Distribute Center": {
      ...
      type: "menu",
      loc: { en: "Object > Distribute > Horizontal Distribute Center", de: "", ru: "" },
      minVersion: 27,
    },
    "menu_Horizontal Distribute Right": {
      action: "Horizontal Distribute Right",
      type: "menu",
      loc: { en: "Object > Distribute > Horizontal Distribute Right", de: "", ru: "" },
      minVersion: 27,
    },
    menu_group: {
      action: "group",
    ...
    "menu_Adobe Action Palette": {
      ...
      type: "menu",
      loc: { en: "Window > Actions", de: "Fenster > Aktionen", ru: "Окно > Операции" },
    },
    ...
    "menu_Adobe Gradient Palette": {
      ...
      type: "menu",
      loc: { en: "Window > Gradient", de: "Fenster > Verlauf", ru: "Окно > Градиент" },
    },
    ...
    "menu_Adobe LinkPalette Menu Item": {
      ...
      type: "menu",
      loc: { en: "Window > Links", de: "Fenster > Verknüpfungen", ru: "Окно > Связи" },
    },
    "menu_AI Magic Wand": {
  ...
  tool: {
    ...
    "tool_Adobe Bloat Tool": {
      ...
      type: "tool",
      loc: { en: "Bloat Tool", de: "Aufblasen-Werkzeug", ru: "Инструмент: Раздувание" },
      minVersion: 24,
    },
    ...
    "tool_Adobe Eraser Tool": {
      ...
      type: "tool",
      loc: { en: "Eraser Tool", de: "Radiergummi-Werkzeug", ru: "Инструмент: Ластик" },
      minVersion: 24,
    },
    "tool_Adobe Eyedropper Tool": {
      action: "Adobe Eyedropper Tool",
      type: "tool",
      loc: { en: "Eyedropper Tool", de: "Pipette-Werkzeug", ru: "Инструмент: Пипетка" },
      minVersion: 24,
    },
    ...
    "tool_Adobe Gradient Vector Tool": {
      ...
      type: "tool",
      loc: { en: "Gradient Tool", de: "Verlauf-Werkzeug", ru: "Инструмент: Градиент" },
      minVersion: 24,
    },
    ...
    "tool_Adobe Freehand Tool": {
      ...
      type: "tool",
      loc: { en: "Pencil Tool", de: "Buntstift-Werkzeug", ru: "Инструмент: Карандаш" },
      minVersion: 24,
    },
    ...
    "tool_Adobe Freehand Smooth Tool": {
      ...
      type: "tool",
      loc: { en: "Smooth Tool", de: "Glätten-Werkzeug", ru: "Инструмент: Сглаживание" },
      minVersion: 24,
    },
    ...
    "tool_Adobe Warp Tool": {
      ...
      type: "tool",
      loc: { en: "Warp Tool", de: "Verkrümmen-Werkzeug", ru: "Инструмент: Деформация" },
      minVersion: 24,
    },
  ...
  config: {
    ...
    config_hideCommand: {
      action: "hideCommand",
      type: "config",
      loc: { en: "Hide Commands...", de: "Befehle ausblenden …", ru: "Скрыть команды" },
    },
    ...
    config_deleteCommand: {
      ...
      type: "config",
      loc: { en: "Delete Commands...", de: "Befehle löschen …", ru: "Удалить команды" },
    },
