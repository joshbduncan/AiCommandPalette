...
(function () {
  ...
  var locStrings = {
    ...
    deleted: { en: "DELETED", de: "GELÖSCHT", ru: "УДАЛЕНО" },
    description: {
    ...
    wf_missing: {
      en: "Workflow needs attention.\nThe following action steps from your workflow are are no longer available.\n\n%1",
      de: "Achtung: Die folgenden Aktionen in Ihrem Arbeitsablauf sind nicht mehr verfügbar.\n\n%1",
  ...
  var builtCommands = {
    ...
    tool: {
      ...
      "tool_Adobe Arc Tool": {
        ...
        type: "tool",
        minVersion: 24,
        loc: { en: "Arc Tool", de: "Bogen-Werkzeug", ru: "Дуга Инструмент" },
      },
      "tool_Adobe Area Graph Tool": {
        ...
        loc: {
          en: "Area Graph Tool",
          de: "Flächendiagramm",
          ru: "Диаграмма с областями Инструмент",
        },
      },
      ...
      "tool_Adobe Crop Tool": {
        ...
        loc: {
          ...
          ru: "Монтажная область Инструмент",
        },
      },
      "tool_Adobe Bar Graph Tool": {
        ...
        loc: {
          ...
          ru: "Диаграмма горизонтальные полосы Инструмент",
        },
      },
      "tool_Adobe Blend Tool": {
        ...
        type: "tool",
        minVersion: 24,
        loc: { en: "Blend Tool", de: "Angleichen-Werkzeug", ru: "Переход Инструмент" },
      },
      ...
      "tool_Adobe Column Graph Tool": {
        ...
        loc: {
          ...
          ru: "Диаграмма вертикальные полосы Инструмент",
        },
      },
      ...
      "tool_Adobe Curvature Tool": {
        ...
        type: "tool",
        minVersion: 24,
        loc: { en: "Curvature Tool", de: "Kurvenzeichner", ru: "Кривизна Инструмент" },
      },
      "tool_Adobe Delete Anchor Point Tool": {
        ...
        loc: {
          ...
          ru: "Удалить опорную точку Инструмент",
        },
      },
      "tool_Adobe Direct Select Tool": {
        ...
        loc: {
          ...
          ru: "Прямое выделение Инструмент",
        },
      },
      "tool_Adobe Ellipse Shape Tool": {
        ...
        type: "tool",
        minVersion: 24,
        loc: { en: "Ellipse Tool", de: "Ellipse-Werkzeug", ru: "Эллипс Инструмент" },
      },
      "tool_Adobe Eraser Tool": {
        action: "Adobe Eraser Tool",
        type: "tool",
        minVersion: 24,
        loc: { en: "Eraser Tool", de: "Radiergummi-Werkzeug", ru: "Ластик Инструмент" },
      },
      ...
      "tool_Adobe Flare Tool": {
        ...
        type: "tool",
        minVersion: 24,
        loc: { en: "Flare Tool", de: "Blendenflecke-Werkzeug", ru: "Блик Инструмент" },
      },
      "tool_Adobe Free Transform Tool": {
        ...
        loc: {
          ...
          ru: "Свободное трансформирование Инструмент",
        },
      },
      "tool_Adobe Gradient Vector Tool": {
        ...
        type: "tool",
        minVersion: 24,
        loc: { en: "Gradient Tool", de: "Verlauf-Werkzeug", ru: "Градиент Инструмент" },
      },
      "tool_Adobe Direct Object Select Tool": {
        ...
        loc: {
          ...
          ru: "Групповое выделение Инструмент",
        },
      },
      "tool_Adobe Scroll Tool": {
        ...
        type: "tool",
        minVersion: 24,
        loc: { en: "Hand Tool", de: "Hand-Werkzeug", ru: "Рука Инструмент" },
      },
      ...
      "tool_Adobe Knife Tool": {
        ...
        type: "tool",
        minVersion: 24,
        loc: { en: "Knife Tool", de: "Messer-Werkzeug", ru: "Нож Инструмент" },
      },
      "tool_Adobe Direct Lasso Tool": {
        action: "Adobe Direct Lasso Tool",
        type: "tool",
        minVersion: 24,
        loc: { en: "Lasso Tool", de: "Lasso-Werkzeug", ru: "Лассо Инструмент" },
      },
      "tool_Adobe Line Graph Tool": {
        ...
        loc: {
          en: "Line Graph Tool",
          de: "Liniendiagramm",
          ru: "Линейная диаграмма Инструмент",
        },
      },
      ...
      "tool_Adobe Planar Face Select Tool": {
        ...
        loc: {
          ...
          ru: "Выделение быстрых заливок Инструмент",
        },
      },
      "tool_Adobe Magic Wand Tool": {
        ...
        loc: {
          ...
          ru: "Волшебная палочка Инструмент",
        },
      },
      "tool_Adobe Measure Tool": {
        ...
        type: "tool",
        minVersion: 24,
        loc: { en: "Measure Tool", de: "Mess-Werkzeug", ru: "Линейка Инструмент" },
      },
      "tool_Adobe Mesh Editing Tool": {
        action: "Adobe Mesh Editing Tool",
        type: "tool",
        minVersion: 24,
        loc: { en: "Mesh Tool", de: "Gitter-Werkzeug", ru: "Сетка Инструмент" },
      },
      "tool_Adobe Brush Tool": {
        action: "Adobe Brush Tool",
        type: "tool",
        minVersion: 24,
        loc: { en: "Paintbrush Tool", de: "Pinsel-Werkzeug", ru: "Кисть Инструмент" },
      },
      "tool_Adobe Freehand Erase Tool": {
        ...
        loc: {
          en: "Path Eraser Tool",
          de: "Löschen-Werkzeug",
          ru: "Стирание контура Инструмент",
        },
      },
      ...
      "tool_Adobe Pen Tool": {
        ...
        type: "tool",
        minVersion: 24,
        loc: { en: "Pen Tool", de: "Zeichenstift-Werkzeug", ru: "Перо Инструмент" },
      },
      "tool_Adobe Freehand Tool": {
        action: "Adobe Freehand Tool",
        type: "tool",
        minVersion: 24,
        loc: { en: "Pencil Tool", de: "Buntstift-Werkzeug", ru: "Карандаш Инструмент" },
      },
      "tool_Perspective Grid Tool": {
        ...
        loc: {
          ...
          ru: "Сетка перспективы Инструмент",
        },
      },
      "tool_Perspective Selection Tool": {
        ...
        loc: {
          ...
          ru: "Выбор перспективы Инструмент",
        },
      },
      "tool_Adobe Pie Graph Tool": {
        ...
        loc: {
          ...
          ru: "Круговая диаграмма Инструмент",
        },
      },
      ...
      "tool_Adobe Page Tool": {
        ...
        loc: {
          ...
          ru: "Разбиение для печати Инструмент",
        },
      },
      ...
      "tool_Adobe Puppet Warp Tool": {
        ...
        loc: {
          ...
          ru: "Марионеточная деформация Инструмент",
        },
      },
      ...
      "tool_Adobe Rectangular Grid Tool": {
        ...
        loc: {
          ...
          ru: "Прямоугольная сетка Инструмент",
        },
      },
      "tool_Adobe Reflect Tool": {
        ...
        loc: {
          ...
          ru: "Зеркальное отражение Инструмент",
        },
      },
      ...
      "tool_Adobe Rotate Tool": {
        ...
        type: "tool",
        minVersion: 24,
        loc: { en: "Rotate Tool", de: "Drehen-Werkzeug", ru: "Поворот Инструмент" },
      },
      ...
      "tool_Adobe Rounded Rectangle Tool": {
        ...
        loc: {
          ...
          ru: "Прямоугольник со скругленными углами Инструмент",
        },
      },
      "tool_Adobe Scale Tool": {
        ...
        type: "tool",
        minVersion: 24,
        loc: { en: "Scale Tool", de: "Skalieren-Werkzeug", ru: "Масштаб Инструмент" },
      },
      "tool_Adobe Scallop Tool": {
        action: "Adobe Scallop Tool",
        type: "tool",
        minVersion: 24,
        loc: { en: "Scallop Tool", de: "Ausbuchten-Werkzeug", ru: "Зубцы Инструмент" },
      },
      "tool_Adobe Scatter Graph Tool": {
        ...
        loc: {
          ...
          de: "Streudiagramm",
          ru: "Точечная диаграмма Инструмент",
        },
      },
      "tool_Adobe Scissors Tool": {
        ...
        type: "tool",
        minVersion: 24,
        loc: { en: "Scissors Tool", de: "Schere-Werkzeug", ru: "Ножницы Инструмент" },
      },
      ...
      "tool_Adobe Shaper Tool": {
        ...
        type: "tool",
        minVersion: 24,
        loc: { en: "Shaper Tool", de: "Shaper-Werkzeug", ru: "Shaper Инструмент" },
      },
      "tool_Adobe Shear Tool": {
        action: "Adobe Shear Tool",
        type: "tool",
        minVersion: 24,
        loc: { en: "Shear Tool", de: "Verbiegen-Werkzeug", ru: "Наклон Инструмент" },
      },
      "tool_Adobe Slice Tool": {
        action: "Adobe Slice Tool",
        type: "tool",
        minVersion: 24,
        loc: { en: "Slice Tool", de: "Slice-Werkzeug", ru: "Фрагменты Инструмент" },
      },
      "tool_Adobe Slice Select Tool": {
        ...
        loc: {
          ...
          ru: "Выделение фрагмента Инструмент",
        },
      },
      ...
      "tool_Adobe Shape Construction Spiral Tool": {
        ...
        type: "tool",
        minVersion: 24,
        loc: { en: "Spiral Tool", de: "Spirale-Werkzeug", ru: "Спираль Инструмент" },
      },
      "tool_Adobe Stacked Bar Graph Tool": {
        ...
        loc: {
          ...
          ru: "Диаграмма горизонтальный стек Инструмент",
        },
      },
      "tool_Adobe Stacked Column Graph Tool": {
        ...
        loc: {
          ...
          ru: "Диаграмма вертикальный стек Инструмент",
        },
      },
      "tool_Adobe Shape Construction Star Tool": {
        ...
        type: "tool",
        minVersion: 24,
        loc: { en: "Star Tool", de: "Stern-Werkzeug", ru: "Звезда Инструмент" },
      },
      "tool_Adobe Symbol Screener Tool": {
        ...
        loc: {
          ...
          ru: "Прозрачность символов Инструмент",
        },
      },
      "tool_Adobe Symbol Scruncher Tool": {
        ...
        loc: {
          ...
          ru: "Уплотнение символов Инструмент",
        },
      },
      "tool_Adobe Symbol Shifter Tool": {
        ...
        loc: {
          ...
          ru: "Смещение символов Инструмент",
        },
      },
      ...
      "tool_Adobe Symbol Spinner Tool": {
        ...
        loc: {
          ...
          ru: "Вращение символов Инструмент",
        },
      },
      "tool_Adobe Symbol Sprayer Tool": {
        ...
        loc: {
          ...
          ru: "Распыление символов Инструмент",
        },
      },
      "tool_Adobe Symbol Stainer Tool": {
        ...
        loc: {
          ...
          ru: "Обесцвечивание символов Инструмент",
        },
      },
      ...
      "tool_Adobe Touch Type Tool": {
        ...
        loc: {
          ...
          ru: "Изменение текста Инструмент",
        },
      },
      "tool_Adobe New Twirl Tool": {
        ...
        type: "tool",
        minVersion: 24,
        loc: { en: "Twirl Tool", de: "Strudel-Werkzeug", ru: "Воронка Инструмент" },
      },
      "tool_Adobe Type Tool": {
        action: "Adobe Type Tool",
        type: "tool",
        minVersion: 24,
        loc: { en: "Type Tool", de: "Text-Werkzeug", ru: "Текст Инструмент" },
      },
      "tool_Adobe Path Type Tool": {
        ...
        loc: {
          ...
          ru: "Текст по контуру Инструмент",
        },
      },
      "tool_Adobe Vertical Area Type Tool": {
        ...
        loc: {
          ...
          ru: "Вертикальный текст в области Инструмент",
        },
      },
      "tool_Adobe Vertical Type Tool": {
        ...
        loc: {
          ...
          ru: "Вертикальный текст Инструмент",
        },
      },
      "tool_Adobe Vertical Path Type Tool": {
        ...
        loc: {
          ...
          ru: "Вертикальный текст по контуру Инструмент",
        },
      },
      ...
      "tool_Adobe Width Tool": {
        ...
        type: "tool",
        minVersion: 24,
        loc: { en: "Width Tool", de: "Breiten-Werkzeug", ru: "Ширина Инструмент" },
      },
      ...
      "tool_Adobe Zoom Tool": {
        ...
        type: "tool",
        minVersion: 24,
        loc: { en: "Zoom Tool", de: "Zoom-Werkzeug", ru: "Масштаб Инструмент" },
      },
    },
    menu: {
      menu_new: {
      ...
      "menu_Live PSAdapter_plugin_CntC": {
        ...
        loc: {
          ...
          de: "Effekt > Zeichenfilter > Conté-Stifte …",
